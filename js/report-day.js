...
var loadMap = function (deviceId) {
    $.get("api-customer/truck/dailyReport", {
            startDate: sTime,
            endDate: sTime,
...
var renderTable = function (dataArray) {
    ...
    dataArray.forEach(function (data) {
            ...
            $("<td class='danger'>" + data['totalWorkTime'].toFixed(2) + "</td>").appendTo(tr);
